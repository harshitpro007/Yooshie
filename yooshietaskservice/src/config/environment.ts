...
export const SERVER = {
  ...
  TASK_MICROSERVICE_URL: process.env["TASK_MICROSERVICE_URL"],
  ...
  SEND_NOTIFICATION_CRON: "notification",
  TASK_REWARD: "reward/task",
  DASHBOARD_LOG: "dashboard/add-logs",

  BUDGET_REWARD: "reward/budget",
