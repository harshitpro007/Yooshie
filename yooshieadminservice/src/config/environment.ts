...
export const SERVER = {
	...
	TOKEN_INFO: {
		...
		EXPIRATION_TIME: {
			...
			FORGOT_PASSWORD: 10 * 60 * 1000, // 2 mins
	...
	TASK_APP_URL: process.env["TASK_APP_URL"],
	...
	USER_TASK_LISTING: "task/taskList",
	ASSISTANT_UPCOMING_TASK: "getUpcomingAssistantTask",
	EDIT_TASK: "task/editTask",
	TASK_DETAILS: "task/taskDetails",
	GOAL_DETAILS: "goal-details",
	REMINDER_DETAILS: "reminder/reminderDetails",
  ...
  CHAT_URL: process.env["CHAT_APP_URL"],
};
