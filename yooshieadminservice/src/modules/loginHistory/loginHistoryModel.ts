...
const loginHistorySchema: Schema = new mongoose.Schema(
  {
    ...
    userId: {
      ...
      inAppNotificationStatus: { type: Boolean, required: false, default: true },
      groupaNotificationStatus: {
        type: Boolean,
        required: false,
        default: true,
      },
 ...
 */
export const login_histories: Model<ILoginHistory> = model<ILoginHistory>(
  DB_MODEL_REF.LOGIN_HISTORY,
  loginHistorySchema
);
