...
const userSchema: Schema = new mongoose.Schema(
  {
    ...
    isAssistantAssigned: { type: Boolean, default: false },
    assistantId: { type: Schema.Types.ObjectId, required: false },
    assistantName: { type: String, required: false },
    assistantProfilePicture: { type: String, required: false },
    assistantAssignedDate: { type: Number, required: false },
    onboardingQues: {
      type: String,
      required: false,
      enum: Object.values(USER_PREFERENCE),
    },
    isFreePlanActive: { type: Boolean, default: false },
    freePlanExpiryDate: { type: Number },
    clientId: { type: String, required: false, unique: true },
    clientNumber: { type: Number, required: false, unique: true },
